...
private Cell[][] board = new Cell[9][9];
	...
	///TODO: CONSTRUCTOR
	//This must initialize every cell on the board with a generic cell.  It must also assign all of the boxIDs to the cell. 
	public Board()
	{
		for(int x = 0; x < 9; x++)
			for(int y = 0 ; y < 9; y++)
	...
	public void loadPuzzle(String level) throws Exception
	{
		...
		if(level.contentEquals("medium"))
			...
			fileName = "/Users/varvara_strykova/Desktop/Varvara S. Java Workspace CS 30 HS/Sudoku Solver/src/hardPuzzle.txt";
